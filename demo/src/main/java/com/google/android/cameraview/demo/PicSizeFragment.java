...
// */
//public class PicSizeFragment extends DialogFragment {
//
...
//    static AspectRatio currentRatio;
//    static Size currentSize;
//
//    public static PicSizeFragment newInstance(SizeMap sizeMap) {
//        final PicSizeFragment fragment = new PicSizeFragment();
//        PicSizeFragment.sizeMap = sizeMap;
//        return fragment;
//    }
//
//    public static void setCurrentRatio(AspectRatio currentRatio) {
//        PicSizeFragment.currentRatio = currentRatio;
//    }
//
//    public static void setCurrentSize(Size currentSize) {
//        PicSizeFragment.currentSize = currentSize;
//    }
//
//    @Override
...
//        @Override
//        public int getCount() {
//            return sizeMap.sizes(currentRatio).size();
//        }
//
//        @Override
//        public SortedSet<Size> getItem(int position) {
//            return sizeMap.sizes(currentRatio);
//        }
//
//        @Override
